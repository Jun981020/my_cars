...
class ReplyServiceTest {
    ...
    public void saveBoard(){
        boardRepository.save(Board.writeBoard("제목입니다1","내용입니다1.",memberRepository.save(Member.createMember("qwer","1234","spring","flwnsgud@naver.com","010-9145-6497", Role.SILVER))));
        boardRepository.save(Board.writeBoard("제목입니다2","내용입니다2.",memberRepository.save(Member.createMember("asdf","5678","boot","dkskwm@naver.com","010-1423-5334", Role.GOLD))));
        boardRepository.save(Board.writeBoard("제목입니다3","내용입니다3.",memberRepository.save(Member.createMember("zxcv","0000","test","fwads@naver.com","010-4232-1231", Role.VIP))));
    }
